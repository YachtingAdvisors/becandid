        ...
        {FREQUENCIES.map((freq) => (
          ...
          >
            ...
            <div className="flex-1">
              <div className="text-sm font-semibold text-on-surface">{FREQUENCY_LABELS[freq]}</div>
              <div className="text-xs text-on-surface-variant mt-0.5">{FREQUENCY_DESCRIPTIONS[freq]}</div>
            </div>
            {value === freq && (
