    ...
    return (
      <div className="card p-5">
        <div className="flex items-center gap-2.5 mb-3">
          ...
          <span className="text-xs text-emerald-600 font-medium ml-auto">✓ Submitted</span>
        </div>
  ...
  return (
    <div className="card p-5">
      ...
      <button onClick={submit} disabled={!rating || saving}
        ...
        {saved ? '✓ Submitted · +10 pts' : saving ? 'Saving…' : 'Submit'}
      </button>
    </div>
  );
}
