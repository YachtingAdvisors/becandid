  ...
  return (
    <div>
      ...
      <select
        ...
        disabled={disabled}
        className="w-full px-3 py-2.5 rounded-xl border border-outline-variant bg-white dark:bg-white/10 text-sm text-on-surface focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-colors disabled:opacity-50"
      >
        {TIMEZONES.map((tz) => (
