...
export default function RivalAssessmentAccordion() {
  ...
  return (
    <div className="relative bg-on-surface text-surface rounded-xl h-64 overflow-hidden transition-all duration-300">
      ...
      >
        ...
        <span className="text-[10px] font-body font-semibold text-surface/60 uppercase tracking-wider mr-1">Optional</span>
