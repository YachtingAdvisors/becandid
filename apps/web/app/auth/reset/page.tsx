      ...
      <div className="relative min-h-screen bg-background flex items-center justify-center px-4 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-xl">
          <div className="bg-surface-container-lowest rounded-[2rem] shadow-[0_4px_40px_rgba(45,112,130,0.06)] border border-outline-variant/15 p-10 sm:p-12 text-center">
            ...
            <Link
              href="/auth/signin"
              className="inline-flex items-center justify-center gap-2 w-full py-5 text-sm font-headline font-bold rounded-full border border-outline-variant/20 text-on-surface-variant hover:bg-surface-container-low transition-colors"
            >
    ...
    <div className="relative min-h-screen bg-background flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-xl">
        ...
        <p className="text-center text-sm text-on-surface-variant mt-8 font-label">
          ...
          <Link href="/auth/signin" className="text-primary font-semibold hover:text-primary-dim transition-colors">Sign in</Link>
        </p>
      </div>
    </div>
  );
