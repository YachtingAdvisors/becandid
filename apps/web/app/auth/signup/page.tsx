    ...
    <main className="min-h-screen pt-16 flex flex-col items-center justify-center p-6 relative overflow-hidden bg-background">
      ...
      <header className="fixed top-0 w-full z-50 bg-background/70 backdrop-blur-md flex items-center justify-between px-6 h-16">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link href="/legal/privacy" className="font-label text-xs uppercase tracking-widest text-on-surface/60 hover:text-primary cursor-pointer transition-all duration-200 focus:ring-2 focus:ring-primary/30 rounded-md px-2 py-1">Privacy</Link>
          <Link href="/legal/terms" className="font-label text-xs uppercase tracking-widest text-on-surface/60 hover:text-primary cursor-pointer transition-all duration-200 focus:ring-2 focus:ring-primary/30 rounded-md px-2 py-1">Security</Link>
        </div>
      </header>
            ...
            <form onSubmit={handleSignUp} className="space-y-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input type="text" value={name} onChange={e => setName(e.target.value)} required
                  className="w-full bg-surface-container-low border-none rounded-xl py-4 px-4 font-body text-on-surface focus:ring-2 focus:ring-primary/30 focus:bg-surface-container-lowest transition-all duration-200"
              ...
              <button type="submit" disabled={!consented || loading}
                className="w-full bg-primary hover:bg-primary-dim hover:brightness-110 text-on-primary font-headline font-bold py-5 px-8 rounded-full transition-all duration-200 shadow-lg shadow-primary/20 hover:shadow-xl active:scale-95 cursor-pointer flex items-center justify-center gap-3 disabled:opacity-50 focus:ring-2 focus:ring-primary/30 motion-reduce:transition-none">
