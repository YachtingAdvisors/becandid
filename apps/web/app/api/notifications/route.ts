...
export async function GET(req: NextRequest) {
  try {
    ...
    const MILESTONE_LABELS: Record<string, string> = {
      ...
      points_100: 'You earned 100 trust points!',
      points_500: '500 trust points milestone!',
      points_1000: '1,000 trust points — well done!',
      points_5000: '5,000 trust points — legendary!',
