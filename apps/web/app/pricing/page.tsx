...
const TIERS = [
  ...
  },
  {
    ...
    highlight: false,
    features: [
      { text: 'Everything in Pro, plus therapist portal access', included: true },
      { text: 'Share journal entries, mood data, streaks & outcomes', included: true },
      { text: 'Granular consent controls — you decide what they see', included: true },
      { text: 'Real-time patterns, journal entries & digital triggers', included: true },
