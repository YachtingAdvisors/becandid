...
export default function SettingsScreen() {
  ...
  }, [displayName, phone, monitoringEnabled]);
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <Pressable style={styles.editLink}>
            ...
            <Ionicons name="chevron-forward" size={16} color="#226779" />
          </Pressable>
        </View>
          ...
          {profile.partner_name ? (
            <View style={styles.partnerRow}>
              <View style={styles.partnerAvatar}>
                <Ionicons name="person" size={20} color="#226779" />
              </View>
              <View style={{ flex: 1 }}>
            ...
            <Pressable style={styles.inviteButton}>
              <Ionicons name="person-add-outline" size={20} color="#226779" />
